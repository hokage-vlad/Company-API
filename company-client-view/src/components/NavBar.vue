    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-dark mb-lg-3">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <router-link v-if="!isLoggedIn" to="/register"><span class="nav-link text-white">Register</span>
            </router-link>
          </li>
        ...
        <div v-if="isLoggedIn" class="ml-auto">
          <ul class="navbar-nav">
            ...
            <li><a class="nav-item nav-link text-danger font-weight-bold" v-if="isLoggedIn" @click.prevent="logoutUser">Logout</a>
            </li>
          </ul>
        </div>
      </div>
